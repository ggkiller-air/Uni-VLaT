...
The site is plain HTML, CSS, and JavaScript. Figures and fonts are served locally. There are no analytics or external embeds. The paper and code buttons currently say “coming soon”; replace them with the official links when those releases are ready.
